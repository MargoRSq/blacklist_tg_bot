...
start_admin = """Комманды:
	...
	/check - Проверить id на наличие в блэк листах
	Пример: 88888888
	/request - оставить заявку о скаме. Добавьте фотографию, ссылку с id и описание. Спам запрещен, в противном случае окажетесь в черном списке(одна заявка в 24 часа)
